...
//  Ftp
//
//  Created by bilal on 22/12/2017.
...
extension FTPUpload {
    ...
    private func setFtpPassword(for ftpWriteStream: CFWriteStream, password: CFString) {
        ...
        let propertyKey2 = CFStreamPropertyKey(rawValue: kCFFTPResourceType)
        CFWriteStreamSetProperty(ftpWriteStream, propertyKey2, "video/quicktime" as CFString)
